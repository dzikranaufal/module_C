...
/*
* Selesaikan fungsi “climbingLeaderBoard” di
bawah.
*
* Fungsi ini diharapkan mengembalikan sebuah
INTERGER_ARRAY.
...
*/
/*
* Untuk mengembalikan integer array dari fungsi,
kamu harus:
* - Simpan ukuran array hasil di variabel
result_count
* - Alokasikan array secara statis atau
dinamis
*
* Contoh,
* int*
return_integer_array_using_static_allocation(int*
result_count) {
* *result_count = 5;
*
...
*
* int*
return_integer_array_using_dynamic_allocation(int*
result_count) {
* *result_count = 5;
*
...
{
    int *array_tanpa_duplikat = malloc(ranked_count * sizeof(int));
    int index = 0;

    array_tanpa_duplikat[0] = ranked[0];
    index++;
    ...
    for (int i = 1; i < ranked_count; i++)
    {
        ...
        {
            array_tanpa_duplikat[index] = ranked[i];
            index++;
        }
    }

    // array yang di outputkan
    ...
    *result_count = player_count;
    ...
    for (int i = 0; i < player_count; i++)
    {
        ...
        {
            if (player[i] < array_tanpa_duplikat[j])
            {
                rank++;
            }
        }
